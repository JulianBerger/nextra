...
import { Cards, RemoteContent } from '@julianberger/nextra/components'
import { buildDynamicMDX } from '@julianberger/nextra/remote'
...
~~~mdx filename="MDX"
import { Cards } from '@julianberger/nextra/components'
